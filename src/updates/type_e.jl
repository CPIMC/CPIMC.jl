...
function remove_type_E!(m::Model, e::Ensemble, c::Configuration) :: Tuple{Float64,Step}
    ...
    apply_step!(c,Δ) # get proposed (new) configuration for inverse proposal probability
    ...
    if direction == :left
        ...
        τ_Intervall = changed_kink_τ - τ_prev_affecting( c.kinks, (removed_kink.k, removed_kink.l,removed_kink.i, removed_kink.j), changed_kink_τ )
    else
        ...
        @assert(in(removed_kink.k,opportunities_new_kink_new_annihilator))
        τ_Intervall =  τ_next_affecting( c.kinks, (removed_kink.i, removed_kink.j,removed_kink.k, removed_kink.l), changed_kink_τ ) - changed_kink_τ
    end
    ...
    inverse_prop_prob = 0.5 / (length(c.kinks)) / length(opportunities_new_kink_new_annihilator) / float(τ_Intervall) / 4 / 16
    ...
    if direction == :left
        delta_di = ΔWdiag_element(m, e, c, removed_kink.i, removed_kink.j, removed_kink.k, removed_kink.l, removed_kink_τ, changed_kink_τ)
        ...
        delta_di = ΔWdiag_element(m, e, c, removed_kink.k, removed_kink.l, removed_kink.i,removed_kink.j, changed_kink_τ, removed_kink_τ)

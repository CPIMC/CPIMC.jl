...
function add_type_E(c::Configuration, e::Ensemble) :: Tuple{Float64,Step}
    ...
    if rand() >= 0.5
        ...
        delta_di = ΔWdiag_element(c, e, new_kink_old_creator, new_kink_new_creator, new_kink_new_annihilator, new_kink_old_annihilator, τ_new_kink, first(old_kink))
        ...
        prop_prob *= 1.0/Float64(τ_Intervall)
                                                          #Inverse new kink
        delta_di = ΔWdiag_element(c, e, new_kink_new_annihilator, new_kink_old_annihilator, new_kink_old_creator, new_kink_new_creator, first(old_kink), τ_new_kink)
...
function remove_type_E(c::Configuration, e::Ensemble) :: Tuple{Float64,Step}
    ...
    if rand() > 0.5
        ...
        delta_di = ΔWdiag_element(apply_step(c,Δ), e, removed_kink.i, removed_kink.j, removed_kink.k, removed_kink.l, removed_kink_τ, changed_kink_τ)

        dw_off_diag = abs(Woffdiag_element(e,removed_kink)) *
                        abs(Woffdiag_element(e,changed_kink_old)) /
        ...
        #calculate weight change
        delta_di = ΔWdiag_element(apply_step(c,Δ), e, removed_kink.k, removed_kink.l, removed_kink.i,removed_kink.j, changed_kink_τ, removed_kink_τ)
